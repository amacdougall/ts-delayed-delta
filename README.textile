...
This fork, at github.com/amacdougall/ts-delayed-delta, exists only to switch Delayed Deltas from DelayedJob to Resque. For that code, see the 1.1.3_resque branch.
